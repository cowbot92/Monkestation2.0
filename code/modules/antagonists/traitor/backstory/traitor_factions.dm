...
/datum/traitor_faction/champions_of_evil
	...
	description = "You've chosen to work for the Champions Of Evil, one of the largest media conglomerates in the system, their main trade is one thing: Violence. Your jobs while working for them will be simple.\n\
	Be as violent as possible, record it for views, and sell it off to them. Oh, and remember, the viewers love a supervillain.\n\
	At the end of the day, you might just get a five digit number where you name is, and enough fame to get away with what you're about to do."
