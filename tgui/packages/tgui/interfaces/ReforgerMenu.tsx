...
import { Button, LabeledList, Section, Stack, Box } from '../components';
...
export const ReforgerMenu = (props) => {
      ...
      <Section fill>
        <Stack fill justify="space-between" vertical textAlign="center">
          ...
          <Stack vertical>
            <Stack.Item>
              <Button.Checkbox
                content="Use Super Monkey Credits(TM) to improve roll chances."
              ...
              />
              <Stack.Item>
                {super_credits_available} Super Monkey Credits(TM) available to
                you.
              </Stack.Item>
              <Button.Checkbox
